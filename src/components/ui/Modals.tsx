    ...
    render() {
        return (
            <div className="gutter-example button-demo">
                <BreadcrumbCustom breads={['UI', 'dialog box']} />
                <Row gutter={16}>
                    <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                ...
                                <p>
                                    <Button onClick={this.showConfirm4}>Confirm box</Button>
                                </p>
                                <p>
                                    <Button onClick={this.info}>message notification</Button>
                                    <Button onClick={this.success}>success</Button>
                                    <Button onClick={this.error}>fail</Button>
                                    <Button onClick={this.warning}>warn</Button>
                                </p>
                                <p>
                                    <Button
                                        type="primary"
