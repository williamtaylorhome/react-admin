    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo">
                <BreadcrumbCustom breads={['UI', 'rich text']} />
                <Row gutter={16}>
                        ...
                        <div className="gutter-box">
                            <Card title="Rich text editor" bordered={false}>
                                <Editor
                                    ...
                                    placeholder="Please enter the text~~Try @Oh, there is a surprise"
                                    spellCheck
                                    onFocus={() => {
                                        console.log('focus');
                                    }}
                    ...
                    <Col className="gutter-row" md={8}>
                        <Card title="Convert HTML synchronously" bordered={false}>
                            <pre>{draftToHtml(editorContent)}</pre>
                        </Card>
                    </Col>
                    <Col className="gutter-row" md={8}>
                        <Card title="Synchronous conversion MarkDown" bordered={false}>
                    ...
                    <Col className="gutter-row" md={8}>
                        <Card title="Convert JSON synchronously" bordered={false}>
